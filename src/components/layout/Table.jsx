...
const headCells = [
  ...
  { id: "title", numeric: true, disablePadding: false, label: "Class Title" },
  {
    id: "desc",
    numeric: true,
  ...
  { id: "start", numeric: true, disablePadding: false, label: "Start Time" },
  { id: "end", numeric: true, disablePadding: false, label: "End Time" },
  {
    id: "course",
    numeric: true,
    disablePadding: false,
...
export default function EnhancedTable() {
  ...
  const emptyRows =
    rowsPerPage - Math.min(rowsPerPage, rows.length - page * rowsPerPage);
                  const [checkboxSelected, setCheckboxSelected] =
                    React.useState(true);
    ...
    <div className={classes.root}>
      <header style={{ marginTop: "10px" }} className="tableheader">
        ...
        <div className="tableheaderbuttons">
          ...
          <CsvDownload className="appbar__button" data={rows}>
            DOWNLOAD AS CSV
          </CsvDownload>
        </div>
      </header>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.classTitle}</TableCell>
                      ...
                      <TableCell align="right">
                        {moment(row.endTime).format("MMMM Do YYYY, h:mm:ss a")}
                      </TableCell>{" "}
                      <TableCell align="right">
                        {row.isMainCourse ? "Full Year" : "Half Year"}
                      </TableCell>
                    </TableRow>
                  );
                })}
